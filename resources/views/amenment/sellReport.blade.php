    ...
    <div class="row gutters">
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        ...
        <div class="card card-primary">
          ...
          <div class="card-body">
            <div class="col-md-12">
              <form method="post" action="{{ route('sell-product-amendment.filter') }}">
        ...
        <div class="card card-primary">
          ...
          <div class="card-body">
            <div class="col-md-12" id="printTable">
              <center><h5 style="margin: 0px">Sell List</h5></center>
                ...
                <table class="" style="width: 100%; font-size: 12px;" cellspacing="0" cellpadding="0">  
                  <thead> 
                    ...
                    <tr> 
                      ...
                      <th style="font-weight: bold; border: 1px solid #ddd; padding: 3px 3px">Invoice</th>
                      ...
                      <th style="font-weight: bold; border: 1px solid #ddd; padding: 3px 3px">Sell Amount</th>
                  ...
                  <tbody> 
                    ...
                    @foreach($alldata as $data)
                      <?php 
                        $rowCount++;
                        $totalQuantity+=$data->ttlQnty;
                        $totalPrice+=$data->ttlPrice;
                      ?>
                    <tr> 
                      ...
                      <td style="border: 1px solid #ddd; padding: 3px 3px"><a href="{{ url('sell-invoice/'.$data->tok) }}" target="_blank">{{$data->tok}}</a></td>
                      <td style="border: 1px solid #ddd; padding: 3px 3px">{{$data->name}}</td>
                      <td style="border: 1px solid #ddd; padding: 3px 3px">{{$data->ttlQnty}}</td>
                      <td style="border: 1px solid #ddd; padding: 3px 3px">{{number_format($data->ttlPrice, 2)}}</td>
                      <td style="border: 1px solid #ddd; padding: 3px 3px">
                          <a href="{{URL::To('amendment/delete-sell-products', $data->tok)}}" class="btn btn-sm btn-danger" onclick="return confirm('Are you Sure?')">Delete</a>
                      </td>
                    </tr>
                    @endforeach
                    @if($rowCount==0)
                  ...
                  <tfoot> 
                    <tr> 
                      ...
                      <td style="border: 1px solid #ddd; padding: 3px 3px"><b></b></td>
                    </tr>
                  </tfoot>
                </table>
