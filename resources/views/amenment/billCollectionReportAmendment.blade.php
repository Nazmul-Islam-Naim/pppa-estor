      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        ...
        <div class="card card-primary">
          <div class="card-header d-flex justify-content-between align-items-center">
            <h3 class="card-title">Customer Bill Collection</h3>
          ...
          <div class="card-body">
            <div class="col-md-12" id="printTable">
              <center><h5 style="margin: 0px">Customer Bill Collection</h5></center>
                ...
                <table class="" style="width: 100%; font-size: 12px;" cellspacing="0" cellpadding="0">  
                  <thead> 
                    ...
                    <tr> 
                      ...
                      <th style="border: 1px solid #ddd; padding: 3px 3px; color: #000">Customer ID</th>
                      <th style="border: 1px solid #ddd; padding: 3px 3px; color: #000">Name</th>
                      <th style="border: 1px solid #ddd; padding: 3px 3px; color: #000">Email</th>
                      <th style="border: 1px solid #ddd; padding: 3px 3px; color: #000">Phone</th>
                      <th style="border: 1px solid #ddd; padding: 3px 3px; color: #000">Amount</th>
                      <th style="border: 1px solid #ddd; padding: 3px 3px; color: #000" width="15%">Action</th>
                    </tr>
                    </tr>
                  </thead>
                  <tbody> 
                    ...
                    <tr> 
                      ...
                      <td style="border: 1px solid #ddd; padding: 3px 3px; color: #000">{{$data->ledger_customer_object->customer_id}}</td>
                      <td style="border: 1px solid #ddd; padding: 3px 3px; color: #000"><a href="{{URL::To('customer-ledger/'.$data->customer_id)}}" target="_blank">{{$data->ledger_customer_object->name}}</a></td>
                      <td style="border: 1px solid #ddd; padding: 3px 3px; color: #000">{{$data->ledger_customer_object->email}}</td>
                      <td style="border: 1px solid #ddd; padding: 3px 3px; color: #000">{{$data->ledger_customer_object->phone}}</td>
