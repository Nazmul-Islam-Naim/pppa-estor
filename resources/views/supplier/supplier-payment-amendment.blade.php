...
@section('title', 'Supplier Payment Amendment')
@section('content')
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card card-primary">
          <div class="card-header d-flex justify-content-between align-items-center">
              <h3 class="card-title">Supplier Payment Amendment</h3>
            </div>
          <!-- /.box-header -->
          <div class="card-body">
            <div class="row">
   ...
   function dateFormat(data) { 
	...
	$(document).ready(function() {
      ...
      var table = $('#example').DataTable({
			...
			processing: true,
      deferRender : true,
			ajax: "{{route('supplier-payment-amendment')}}",
      ...
      $("#example").on("click", ".button-delete", function(e) {
			...
			var id = $(this).data('id');
			var link = '{{route("supplier-payment-destroy",":id")}}';
