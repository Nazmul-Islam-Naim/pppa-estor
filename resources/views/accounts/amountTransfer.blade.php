      ...
      <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">{{ __('menu.amount_transfer') }}</h3>
          </div>
          <!-- /.card-header -->
          <!-- form start -->
          ...
          <div class="card-body">
            <div class="field-wrapper">
              <div class="input-group">
                ...
                <input type="hidden" class="form-control" name="bank_id" value="{{encrypt($alldata->id)}}">
              </div>
            ...
            <div class="field-wrapper">
              ...
              <div class="field-placeholder">{{ __('menu.transfer_to') }} <span class="text-danger">*</span></div>
            </div>
            <div class="field-wrapper">
              <div class="input-group">
                <input class="form-control decimal" type="text" name="transfer_amount" value="" autocomplete="off" required="">
              </div>
