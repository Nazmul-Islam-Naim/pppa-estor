    ...
    <div class="row gutters">
      ...
      <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
        @if(!empty($single_data))
          {!! Form::open(array('route' =>['account-type.update', encrypt($single_data->id)],'method'=>'PUT','files'=>true)) !!}
          <?php $info ="Update";?>
        @else
        {!! Form::open(array('route' =>['account-type.store'],'method'=>'POST','files'=>true)) !!}
          <?php $info ="Add";?>
        @endif
        <div class="card">
          <div class="card-header">
            <div class="card-title">{{$info}} {{ __('menu.account_type') }} </div>
          </div>
          <div class="card-body">
            <!-- Row start -->
            <div class="row gutters">
      ...
      <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
        <div class="card">
          <div class="card-header">
            <div class="card-title">{{ __('home.Account_Types') }}</div>
          </div>
          <div class="card-body">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="actions" style="height: 25px">
                        <a href="{{ route('account-type.edit', encrypt($data->id)) }}" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
                          <i class="icon-edit1 text-info"></i>
                        </a>
                        {{Form::open(array('route'=>['account-type.destroy',encrypt($data->id)],'method'=>'DELETE'))}}
