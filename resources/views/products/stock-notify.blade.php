...
@section('title', ' Low Stock Product Report')
@section('content')
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card card-primary">
          <div class="card-header d-flex justify-content-between align-items-center">
              <h3 class="card-title">Low Stock Product Report</h3>
            </div>
          <!-- /.box-header -->
          <div class="card-body">
            <div class="row">
      ...
      dom: 'Blfrtip',
			...
			columns: [
        {
          ...
          render:function(data, display, row){
              if(row.quantity > row.product.stock_notify){
                  return '<span>'+ data + '</span>';
              }else if((row.quantity <= row.product.stock_notify) && (row.quantity > 0)){
