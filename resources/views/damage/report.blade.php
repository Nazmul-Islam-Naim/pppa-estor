...
@section('title', 'Requisition Report for Damage Product')
@section('content')
...
<script>
   ...
   function dateFormat(data) { 
    ...
    function filter_view(start_date = '',end_date = '') { 
      ...
      deferRender : true,
			ajax: {
        url: "{{route('damagerequests.report')}}",
      ...
      dom: 'Blfrtip',
        ...
        {
          data: 'damage_request.user.name',
        },
        {
          data: 'damage_request.user.designation.title',
        },
        {
          data: 'product.name',
        },
