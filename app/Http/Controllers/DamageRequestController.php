...
use App\Enum\Status;
use App\Models\DamageRequestComment;
...
use App\Notifications\DamageRequestNotification;
use Carbon\Carbon;
use DataTables;
use Validator;
use Response;
...
class DamageRequestController extends Controller
{
    ...
    {
        $data['single_data'] = DamageRequest::authorized()->where('id',$id)->first();
    ...
    public function statusupdate(Request $request, $id)
    {
        ...
        try{
            ...
            if($status->toString() == "Approver" && $damagerequest->can($status,$user)){
                ...
                //     Notification::send($admins,new DamageRequestNotification($damagerequest));
            ...
            $test = DamageRequestComment::create([
    ...
    public function destroy($id)
    {
        ...
        $data = DamageRequest::findOrFail($id);
        $action = $data->delete();
